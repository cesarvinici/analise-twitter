...
m <- mongo(url = "mongodb://192.168.16.2/", options = ssl_options(weak_cert_validation = T), db="twitter", collection="tweets_bolsonaro")
...
# Cria o WordCount
png("graficos/wordcloud_bolsonaro.png")
